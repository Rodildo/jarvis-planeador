...
**Última actualización:** 21 de septiembre de 2026, después de: soporte bilingüe español/inglés completo (interfaz + contenido generado por IA), mecanismo de versión obsoleta forzada, confirmación con contraseña antes de regenerar el Life Blueprint, "nunca pantallas vacías" en Plan Maestro/Historial, y la primera build publicada con todo esto (`kAppBuildNumber = 1`). Antes de eso: multiusuario con auth real, brief de 50 preguntas con banco fijo, plan diario en 3 bloques, notificaciones 3x/día, historial con predicción de energía, foto de perfil, y política de privacidad/términos.
