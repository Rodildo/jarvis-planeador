          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isSelected ? intensityColor.withOpacity(0.15) : Colors.white.withOpacity(0.05),
                border: Border.all(
                  color: isSelected ? intensityColor.withOpacity(0.5) : Colors.white.withOpacity(0.1),
