...
exports.transcribeAudio = exports.generateNextOnboardingQuestion = exports.generateMidDayAdjustment = exports.generateMorningOptions = exports.generateBlueprint = void 0;
const OPENROUTER_URL = "https://openrouter.ai/api/v1/chat/completions";
const MODEL_NAME = "openrouter/free";
const callOpenRouter = async (systemPrompt, userMessage, forceJson = false) => {
...
const generateBlueprint = async (answers) => {
...
const generateMorningOptions = async (blueprint, energyLevel) => {
    let modeContext = "";
    if (energyLevel <= 2) {
...
exports.generateMorningOptions = generateMorningOptions;
const generateMidDayAdjustment = async (blueprint, morningEnergy, middayEnergy, chosenActions) => {
...
exports.generateMidDayAdjustment = generateMidDayAdjustment;
const generateNextOnboardingQuestion = async (previousQA) => {
...
exports.generateNextOnboardingQuestion = generateNextOnboardingQuestion;
